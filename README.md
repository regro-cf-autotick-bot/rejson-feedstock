...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rejson-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13893&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rejson-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rejson` can be installed with:

```
conda install rejson
```

It is possible to list all of the versions of `rejson` available on your platform with:
